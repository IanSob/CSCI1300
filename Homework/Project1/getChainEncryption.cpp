...
int main()
{
    ...
    getChainEncryption(inputMessage, methodAsInteger, inputKey1, inputKey2, inputPhrase);
    //Output
    cout << "The encrypted message : " 
    << getChainEncryption(inputMessage, methodAsInteger, inputKey1, inputKey2, inputPhrase) << endl;
