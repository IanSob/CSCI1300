...
int main()
{
    ...
    cout << "Enter the type of pass you wish to purchase ('B', 'I', 'A', 'P'):\n";
    cin >> planSelection;
    ...
    budgetInput = balanceAfterPurchase;
    balanceAfterPurchase = purchasePass(balanceAfterPurchase, planSelection);

    if(budgetInput != balanceAfterPurchase)
    {
        cout << "Another pass purchased for your friend. Remaining budget: $" << balanceAfterPurchase << endl;
    }
    else
    {
